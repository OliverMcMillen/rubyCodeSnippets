...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference("Snippet.count") do
      post snippets_url, params: { snippet: { content: @snippet.content, user: @snippet.user } }
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { content: @snippet.content, user: @snippet.user } }
